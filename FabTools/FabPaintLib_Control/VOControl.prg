...
METHOD __DrawControl( hMemDC as ptr ) as void  
	...
	IF SELF:IsValid
		...
		ELSE
            ...
            rcSrc:Left	    := 0
            rcSrc:Top	    := 0
			rcSrc:Right	    := self:oImg:Width
			rcSrc:Bottom    := self:oImg:Height
			//
